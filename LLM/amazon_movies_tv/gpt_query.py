...
infile = 'amazon_movies_tv_gpt_test.jsonl'
...
# model = 'ft:gpt-3.5-turbo-0613:personal:amazon-mt-64-3:8Bz0RDBm'
# model = 'ft:gpt-3.5-turbo-0613:personal:amazon-mt-1024-3:88gDroaw'
